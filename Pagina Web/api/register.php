...
if (!$nom || !$email || !$password) {
    ...
    echo json_encode(['success' => false, 'error' => 'Nom, email i contrasenya son obligatoris.']);
    exit;
}
...
if (strlen($password) < 8) {
    http_response_code(400);
    echo json_encode(['success' => false, 'error' => 'La contrasenya ha de tenir minim 8 caracters.']);
    exit;
}

$plans_valids = ['basic', 'pro', 'enterprise', 'mensual', 'anual', ''];
...
if ($stmt->fetch()) {
    ...
    echo json_encode(['success' => false, 'error' => 'Aquest email ja esta registrat.']);
    exit;
}
...
$preus = ['mensual' => 9.99, 'anual' => 99.99, 'basic' => 9.99, 'pro' => 19.99, 'enterprise' => 49.99];
